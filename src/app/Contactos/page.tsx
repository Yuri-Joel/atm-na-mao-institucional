...
const Page = () => {
  return (
    <>
      <main className="relative w-full px-2 md:px-30 bg-[#0B1221] flex flex-col items-center text-black">
        ...
        <main className="w-full flex flex-col justify-center gap-8 z-1">
          ...
          <section className="w-full flex items-center justify-center">
            <div className="flex flex-col items-center justify-center relative sm:flex-row gap-4">
              <Button className="bg-blue-500 cursor-pointer  z-2 w-[300px] hover:bg-blue-800 text-white h-12 px-8 text-base font-semibold flex items-center justify-center gap-2">
                Baixar agora
                <Download className="w-5 h-5" />
              </Button>
              <div className="bg-blue-400 absolute animate-ping w-[160px] shadow-blue-400 rounded-md h-9"></div>
            </div>
          </section>
           <section className="w-full flex items-center justify-center">
...
<div className="grid grid-cols-3 gap-2 px-10 md:pt-8 text-white">
         ...
         <section className="relative w-full pt-10 flex flex-col md:flex-row items-center justify-center  ">
                ...
                <div className="items-center w-full flex flex-col justify-center md:justify-start md:w-[40%]">
                  ...
                  <p className="md:text-xl text-foreground/70 text-white text-center md:text-left leading-relaxed">
...
<p className="text-md text-foreground/70 text-white leading-relaxed text-center md:text-left ">
...
ATM NA MÃO fornece informações em tempo real sobre localização, estado e disponibilidade dos caixas automáticos. Reduz filas desnecessárias, economiza tempo dos utilizadores e contribui para a modernização do setor financeiro angolano.
             ...
             <section className="relative w-full md:pt-10 flex items-center justify-center  ">
          

     <section className="w-full flex items-center justify-center p-10 md:p-40">
            <div className="flex flex-col items-center justify-center relative sm:flex-row gap-4">
              <Button className="bg-blue-500 cursor-pointer  z-2 w-[300px] hover:bg-blue-800 text-white h-12 px-8 text-base font-semibold flex items-center justify-center gap-2">
               ver mais
